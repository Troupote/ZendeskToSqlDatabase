/*
    ...
    Enfin, il récupère les tickets Zendesk à l'aide de l'API ZendeskApi_v2 et les insère dans la base de données SQL.
...
void CheckInternetConnection()
{
    ...
    {
        Console.WriteLine("Pas de connexion Internet. La console se fermera dans 10 secondes.");
        Thread.Sleep(10000);
        Environment.Exit(0);
    }
}
